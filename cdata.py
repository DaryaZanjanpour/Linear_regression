...
plt.xlabel('intensity of ocean optic data')
plt.ylabel('Wavelength of ocean optic data')
plt.savefig('moosh.png') 
...
peaks_neon, _ = find_peaks(flipdata[300,:], height=1271)
...
calibratedpixel= ((data[340,:]-AvgDark[340,:])/(Avgflat[340,:]-AvgDark[340,:]))*Planck(9602)
#print("pixel calibration=", calibratedpixel)
...
calibratedpixel= ((data[340,:]-AvgDark[340,:])/(Avgflat[340,:]-AvgDark[340,:]))*Planck(4379)
#print("pixel calibration=", calibratedpixel)
...
calibratedpixel= ((data[340,:]-AvgDark[340,:])/(Avgflat[340,:]-AvgDark[340,:]))*Planck(30000)
#print("pixel calibration=", calibratedpixel)
...
calibratedpixel= ((data[340,:]-AvgDark[340,:])/(Avgflat[340,:]-AvgDark[340,:]))*Planck(3689)
#print("pixel calibration=", calibratedpixel)
...
hdu = fits.open(path2data)
hdu[0].header
data = hdu[0].data-1/1.1111*dark300
print(data)
...
calibratedpixel= ((data[340,:]-dark300)/(Avgflat[340,:]-dark300))*Planck(-392)
#print("pixel calibration=", calibratedpixel)
